...
// import { dummyProducts } from "@/state/dummyProducts";
...
//   params: {
//     productId: string; // Ensure productId is a string for routing purposes
//   };
// }
...
//     setQuantity((prev) => Math.min(prev + 1, product.stockQuantity)); // Limit to stockQuantity
//   };
...
//             <Image
//              src="https://s3-inventorymanagement12.s3.us-east-2.amazonaws.com/product1.png"
//               alt={product.name}
//               width={500}
//               height={500}
...
//                 product.stockQuantity > 0 ? "text-[#008081]" : "text-red-600"
//               }`}
//             >
